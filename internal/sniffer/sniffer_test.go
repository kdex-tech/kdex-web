...
func TestRequestSniffer_mergeAPIIntoFunction(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			assertions: func(t *testing.T, fn *kdexv1alpha1.KDexFunction) {
				item, ok := fn.Spec.API.Paths["/foo"]
				assert.True(t, ok)
				assert.Equal(t, "Auto-generated from request to /foo", item.Description)
			},
		},
		{
			name:  "add new schema",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s.mergeAPIIntoFunction(tt.out, tt.paths, tt.schemas, tt.keepConflicts)
...
func TestRequestSniffer_parseRequestIntoAPI(t *testing.T) {
	...
	tests := []struct {
		name       string
		r          *http.Request
		assertions func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error)
		skip       bool
	}{
		{
			name: "GET /foo",
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				item, ok := op["/foo"]
				assert.True(t, ok)
				assert.Equal(t, "gen-foo-get", item.GetGet().OperationID)
		...
		},
		{
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				assert.True(t, ok)
				assert.Equal(t, "gen-foo-get", item.GetGet().OperationID)
				assert.Equal(t, []string{"one", "two", "three"}, item.GetGet().Tags)
			},
		},
		{
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				assert.True(t, ok)
				assert.Equal(t, "gen-foo-get", item.GetGet().OperationID)
				assert.Equal(t, "custom description", item.GetGet().Description)
				assert.Equal(t, "custom summary", item.GetGet().Summary)
			},
		},
		{
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				assert.True(t, ok)
				assert.Equal(t, "gen-foo-get", item.GetGet().OperationID)
				assert.Equal(t, 1, item.GetGet().Responses.Len())
				resp := item.GetGet().Responses.Value("200")
		...
		},
		{
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				assert.Len(t, *item.GetGet().Security, 1)
				assert.Contains(t, (*item.GetGet().Security)[0], "bearer")
			},
		},
		{
			name: "query array",
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				item, ok := op["/test"]
				assert.True(t, ok)
				assert.Equal(t, "gen-test-get", item.GetGet().OperationID)
				found := false
				for _, p := range item.GetGet().Parameters {
					if p.Value.Name == "id" {
	...
	"address": {
		...
		"Country": "BQ"
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				item, ok := op["/test"]
				assert.True(t, ok)
				assert.NotNil(t, item.GetPost().RequestBody)
				content := item.GetPost().RequestBody.Value.Content["application/json"]
	...
	"address": {
		...
		},
		{
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				assert.True(t, ok)
				assert.NotNil(t, item.GetPost().RequestBody)
				content := item.GetPost().RequestBody.Value.Content["application/octet-stream"]
				assert.NotNil(t, content)
				assert.Equal(t, &expected, content.Schema.Value)
			},
		},
		{
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				assert.True(t, ok)
				assert.NotNil(t, item.GetPost().RequestBody)
				content := item.GetPost().RequestBody.Value.Content["application/x-www-form-urlencoded"]
				assert.NotNil(t, content)
				assert.Equal(t, &expected, content.Schema.Value)
			},
		},
		{
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				assert.True(t, ok)
				assert.NotNil(t, item.GetPost().RequestBody)
				content := item.GetPost().RequestBody.Value.Content["multipart/form-data"]
				assert.NotNil(t, content)
		...
		},
		{
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				item, ok := op["/test"]
				assert.True(t, ok)
				assert.NotNil(t, item.GetPatch().RequestBody)
				content := item.GetPatch().RequestBody.Value.Content["application/json-patch+json"]
				assert.NotNil(t, content)
		...
		},
		{
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				item, ok := op["/test"]
				assert.True(t, ok)
				assert.Equal(t, "CONNECT /test", item.GetConnect().Description)
			},
		},
		{
			name: "DELETE /test",
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				item, ok := op["/test"]
				assert.True(t, ok)
				assert.Equal(t, "DELETE /test", item.GetDelete().Description)
			},
		},
		{
			name: "HEAD /test",
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				item, ok := op["/test"]
				assert.True(t, ok)
				assert.Equal(t, "HEAD /test", item.GetHead().Description)
			},
		},
		{
			name: "OPTIONS /test",
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				item, ok := op["/test"]
				assert.True(t, ok)
				assert.Equal(t, "OPTIONS /test", item.GetOptions().Description)
			},
		},
		{
			name: "PATCH /test",
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				item, ok := op["/test"]
				assert.True(t, ok)
				assert.Equal(t, "PATCH /test", item.GetPatch().Description)
			},
		},
		{
			name: "PUT /test",
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				item, ok := op["/test"]
				assert.True(t, ok)
				assert.Equal(t, "PUT /test", item.GetPut().Description)
			},
		},
		{
			name: "TRACE /test",
			...
			assertions: func(t *testing.T, op map[string]kdexv1alpha1.PathItem, schemas map[string]*openapi.SchemaRef, err error) {
				...
				item, ok := op["/test"]
				assert.True(t, ok)
				assert.Equal(t, "TRACE /test", item.GetTrace().Description)
			},
		},
	}
	for _, tt := range tests {
...
func TestRequestSniffer_parseRequestIntoAPI_and_mergeAPIIntoFunction(t *testing.T) {
	...
	paths, schemas, err := s.parseRequestIntoAPI(
		...
		operationId)
	assert.NoError(t, err)
	s.mergeAPIIntoFunction(fn, paths, schemas, false)
	...
	expected := &kdexv1alpha1.KDexFunction{
		Spec: kdexv1alpha1.KDexFunctionSpec{
			API: kdexv1alpha1.API{
				Paths: map[string]kdexv1alpha1.PathItem{
					"/v2/users/{id}": {
						Description: "Auto-generated from request to /v2/users/{id}",
						Put: raw(&openapi.Operation{
	...
	r = httptest.NewRequest("DELETE", "/v2/users/{id}", http.NoBody)
	r.Header.Set("Accept", "application/json")
	r.Header.Set("X-KDex-Function-Pattern-Path", pattern)
	r.Header.Set("X-KDex-Function-Response-Schema-Ref", "User")
...
func TestRequestSniffer_sniff(t *testing.T) {
	tests := []struct {
		...
		{
			name: "GET /v1/foo with X-KDex-Function-Pattern-Path that is not a pattern",
			r: func() *http.Request {
				it := httptest.NewRequest("GET", "/v1/foo", http.NoBody)
				it.Header.Set("X-KDex-Function-Pattern-Path", "/v1/bar")
				return it
			}(),
			wantErr: "does not contain any path wildcards",
		},
		{
			name: "GET /v1/foo with X-KDex-Function-Pattern-Path that does not have basepath prefix",
			r: func() *http.Request {
			...
			want: &kdexv1alpha1.KDexFunction{
				...
				Spec: kdexv1alpha1.KDexFunctionSpec{
					API: kdexv1alpha1.API{
						...
						Paths: map[string]kdexv1alpha1.PathItem{
							"/v1/foo/{bar}": {
								Description: "Auto-generated from request to /v1/foo/{bar}",
								Get: raw(&openapi.Operation{
